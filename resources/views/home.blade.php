...
<div class="welcome-msg pt-3 pb-4">
    ...
    <p>Plots Management System - Admin Dashboard.</p>
</div>
            ...
            <div class="row">
                <div class="col-sm-6 pr-sm-2 statistics-grid">
                    <div class="card card_border border-primary-top p-4">
                        ...
                        <h3 class="text-primary number">200</h3>
                ...
                <div class="col-sm-6 pl-sm-2 statistics-grid">
                    <div class="card card_border border-primary-top p-4">
                        <i class="fa fa-th"> </i>
                        <h3 class="text-secondary number">1230 K</h3>
        ...
        <div class="col-xl-6 pl-xl-2">
            <div class="row">
                <div class="col-sm-6 pr-sm-2 statistics-grid">
                    <div class="card card_border border-primary-top p-4">
                        <i class="fa fa-th"> </i>
                        <h3 class="text-success number">104</h3>
                ...
                <div class="col-sm-6 pl-sm-2 statistics-grid">
                    <div class="card card_border border-primary-top p-4">
                        <i class="fa fa-th"> </i>
                        <h3 class="text-danger number">58</h3>
